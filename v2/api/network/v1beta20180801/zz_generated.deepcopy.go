...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Endpoint_ARM) DeepCopyInto(out *Endpoint_ARM) {
	*out = *in
	if in.Id != nil {
		in, out := &in.Id, &out.Id
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Endpoint_ARM.
func (in *Endpoint_ARM) DeepCopy() *Endpoint_ARM {
	if in == nil {
		return nil
	}
	out := new(Endpoint_ARM)
	in.DeepCopyInto(out)
	return out
}
