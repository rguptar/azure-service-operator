...
func RunResourceConversionTestForTrafficmanagerprofile(subject Trafficmanagerprofile) string {
	...
	var hub v20180801s.Trafficmanagerprofile
...
// RunPropertyAssignmentTestForTrafficmanagerprofile tests if a specific instance of Trafficmanagerprofile can be assigned to v1beta20180801storage and back losslessly
func RunPropertyAssignmentTestForTrafficmanagerprofile(subject Trafficmanagerprofile) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20180801s.Trafficmanagerprofile
...
// RunPropertyAssignmentTestForTrafficmanagerprofile_Spec tests if a specific instance of Trafficmanagerprofile_Spec can be assigned to v1beta20180801storage and back losslessly
func RunPropertyAssignmentTestForTrafficmanagerprofile_Spec(subject Trafficmanagerprofile_Spec) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20180801s.Trafficmanagerprofile_Spec
...
// RunPropertyAssignmentTestForTrafficmanagerprofile_STATUS tests if a specific instance of Trafficmanagerprofile_STATUS can be assigned to v1beta20180801storage and back losslessly
func RunPropertyAssignmentTestForTrafficmanagerprofile_STATUS(subject Trafficmanagerprofile_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20180801s.Trafficmanagerprofile_STATUS
...
// RunPropertyAssignmentTestForDnsConfig tests if a specific instance of DnsConfig can be assigned to v1beta20180801storage and back losslessly
func RunPropertyAssignmentTestForDnsConfig(subject DnsConfig) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20180801s.DnsConfig
...
// RunPropertyAssignmentTestForDnsConfig_STATUS tests if a specific instance of DnsConfig_STATUS can be assigned to v1beta20180801storage and back losslessly
func RunPropertyAssignmentTestForDnsConfig_STATUS(subject DnsConfig_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20180801s.DnsConfig_STATUS
...
// RunPropertyAssignmentTestForEndpoint tests if a specific instance of Endpoint can be assigned to v1beta20180801storage and back losslessly
func RunPropertyAssignmentTestForEndpoint(subject Endpoint) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20180801s.Endpoint
...
// RunPropertyAssignmentTestForEndpoint_STATUS tests if a specific instance of Endpoint_STATUS can be assigned to v1beta20180801storage and back losslessly
func RunPropertyAssignmentTestForEndpoint_STATUS(subject Endpoint_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20180801s.Endpoint_STATUS
...
// RunPropertyAssignmentTestForMonitorConfig tests if a specific instance of MonitorConfig can be assigned to v1beta20180801storage and back losslessly
func RunPropertyAssignmentTestForMonitorConfig(subject MonitorConfig) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20180801s.MonitorConfig
...
// RunPropertyAssignmentTestForMonitorConfig_STATUS tests if a specific instance of MonitorConfig_STATUS can be assigned to v1beta20180801storage and back losslessly
func RunPropertyAssignmentTestForMonitorConfig_STATUS(subject MonitorConfig_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20180801s.MonitorConfig_STATUS
...
// RunPropertyAssignmentTestForMonitorConfig_CustomHeaders tests if a specific instance of MonitorConfig_CustomHeaders can be assigned to v1beta20180801storage and back losslessly
func RunPropertyAssignmentTestForMonitorConfig_CustomHeaders(subject MonitorConfig_CustomHeaders) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20180801s.MonitorConfig_CustomHeaders
...
// RunPropertyAssignmentTestForMonitorConfig_CustomHeaders_STATUS tests if a specific instance of MonitorConfig_CustomHeaders_STATUS can be assigned to v1beta20180801storage and back losslessly
func RunPropertyAssignmentTestForMonitorConfig_CustomHeaders_STATUS(subject MonitorConfig_CustomHeaders_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20180801s.MonitorConfig_CustomHeaders_STATUS
...
// RunPropertyAssignmentTestForMonitorConfig_ExpectedStatusCodeRanges tests if a specific instance of MonitorConfig_ExpectedStatusCodeRanges can be assigned to v1beta20180801storage and back losslessly
func RunPropertyAssignmentTestForMonitorConfig_ExpectedStatusCodeRanges(subject MonitorConfig_ExpectedStatusCodeRanges) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20180801s.MonitorConfig_ExpectedStatusCodeRanges
...
// RunPropertyAssignmentTestForMonitorConfig_ExpectedStatusCodeRanges_STATUS tests if a specific instance of MonitorConfig_ExpectedStatusCodeRanges_STATUS can be assigned to v1beta20180801storage and back losslessly
func RunPropertyAssignmentTestForMonitorConfig_ExpectedStatusCodeRanges_STATUS(subject MonitorConfig_ExpectedStatusCodeRanges_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20180801s.MonitorConfig_ExpectedStatusCodeRanges_STATUS
